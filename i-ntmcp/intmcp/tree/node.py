...
class Node:
    ...
    def get_child(self, target_h: Any, **kwargs):
        ...
        if child_node.nid == 167247:
            print("generated root", child_node.nid)
            print(child_node)
            print(child_node.belief, child_node.belief.size())
            print(child_node.parent)
            print(child_node.parent.parent)
            print(child_node.parent.parent.parent)
